    ...
    <section id="services" className="pt-10 pb-24">
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          integrated via jest for instance. The entire testing involves unit testing, 
          component testing, end-to-end testing, and cross
           browser compatibility testing (using cypress GUI steps).
          </p>
        </motion.div>
      </div>
    </section>
