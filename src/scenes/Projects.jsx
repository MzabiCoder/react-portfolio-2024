...
const Project = ({ image, github, project, title, login }) => {
  const overlayStyles = `absolute h-full w-full opacity-0 hover:opacity-90 transition duration-500
  bg-amber-300 z-30 flex flex-col justify-center items-center text-center p-16 text-deep-blue`;
  ...
  return (
    <motion.div variants={projectVariant} className="relative">
      <div className={overlayStyles}>
        ...
        {login && <div className="pt-12 font-semibold"><h1>login: nabil@nabil.com</h1>
          <h1>passowrd: 12345</h1></div>}
      </div>
    ...
    <section id="projects" className="pt-48 pb-48">
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          <Project login={true} github={projectDetails5.github} project={projectDetails5.project} image={projectDetails5.image} title="Project 5" />
